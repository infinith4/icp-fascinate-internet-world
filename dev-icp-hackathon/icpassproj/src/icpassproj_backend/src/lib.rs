pub mod icpassproj_backend_lib {
    ...
    //Nat: dfx canister call icpassproj_backend delete_password "(0 : nat)"
    //usize: dfx canister call icpassproj_backend delete_password "(0 : nat64)"
